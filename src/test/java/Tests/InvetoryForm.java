...
public class InvetoryForm extends WebTestBase {


    @Test
    public void FormTest() throws InterruptedException {
        // Sets up an "Explicit Wait" that pauses the test for up to 20 seconds until specific conditions (like visibility) are met
        ...
        loginActions.enterEmailAddress("melsat@gmail.com");
       ...
       //step 15.Click Confirm Purchase
        ...
        WebElement viewButton = driver.findElement(By.xpath("//button[contains(@id, 'view-invoice-')]"));
        viewButton.click();
        Thread.sleep(2000);
    }
}